...
import { TestSnapshots, assert, registerTestObservable, testObservables, runSSRTest } from './util'
...
if (typeof window === 'undefined') runSSRTest(name, TestClassesArrayStore)
