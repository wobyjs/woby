...
import { TestSnapshots, useInterval, useTimeout, TEST_INTERVAL, registerTestObservable, testObservables, assert, runSSRTest } from './util'
...
if (typeof window === 'undefined') runSSRTest(name, TestSelectObservableOption)
