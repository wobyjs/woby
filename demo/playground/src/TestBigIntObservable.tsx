...
import { TestSnapshots, useInterval, TEST_INTERVAL, registerTestObservable, testObservables, randomBigInt, assert, runSSRTest } from './util'
...
if (typeof window === 'undefined') runSSRTest(name, TestBigIntObservable)
