...
TestContextComponents.test = {
    ...
    expect: () => {
        ...
        const expectedFull = minimiseHtml( '<h3>Context - Components</h3><p data-test="first-fn">outer</p><span data-test="first-span">separator</span><p data-test="nested-first">inner</p><div data-test="nested-middle"><span>nested content</span></div><p data-test="nested-last">inner</p><p data-test="last-fn">outer</p><h3>Context.Provider(value, () => ) Test</h3><p data-test="fn-provider">Component function provider: component-function-value</p><h3>Multiple Siblings Test</h3><p data-test="sibling-1">First: multi-test</p><p data-test="sibling-2">Second: multi-test</p><div data-test="sibling-3"><p data-test="sibling-3-nested">Nested: multi-test</p></div><p data-test="sibling-4">Last: multi-test</p>' ) // For SSR comparison
        const expected =  minimiseHtml('<p data-test="first-fn">outer</p><span data-test="first-span">separator</span><p data-test="nested-first">inner</p><div data-test="nested-middle"><span>nested content</span></div><p data-test="nested-last">inner</p><p data-test="last-fn">outer</p><h3>Context.Provider(value, () => ) Test</h3><p data-test="fn-provider">Component function provider: component-function-value</p><h3>Multiple Siblings Test</h3><p data-test="sibling-1">First: multi-test</p><p data-test="sibling-2">Second: multi-test</p><div data-test="sibling-3"><p data-test="sibling-3-nested">Nested: multi-test</p></div><p data-test="sibling-4">Last: multi-test</p>')   // For main test comparison
...
if (typeof window === 'undefined') runSSRTest(name, TestContextComponents)
