...
import { TestSnapshots, TEST_INTERVAL, useInterval, registerTestObservable, testObservables, assert, runSSRTest } from './util'
...
if (typeof window === 'undefined') runSSRTest(name, TestStylesStore)
