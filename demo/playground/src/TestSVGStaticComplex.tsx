            ...
            if (ssrComponent && (typeof ssrComponent === 'object' || typeof ssrComponent === 'function')) {
                ...
                renderToString(elementToRender).then(ssrResult => {
                    ...
                    if (ssrResult !== expectedFull) {
                        assert(false, `[TestSVGStaticComplex] SSR mismatch: got ${ssrResult}, expected ${expectedFull}`)
                    } else {
                        console.log(`✅ [TestSVGStaticComplex] SSR test passed: ${ssrResult}`)
                    }
                }).catch(err => {
                    console.error(`[TestSVGStaticComplex] SSR render error: ${err}`)
                })
            }
        }, 0)
