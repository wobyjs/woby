...
TestPropertyCheckedFunction.test = {
    ...
    expect: () => {
        ...
        const expectedFull = '<h3>Property - Checked Function</h3><p><input type="checkbox" checked="" /></p>'  // For SSR comparison
...
if (typeof window === 'undefined') runSSRTest(name, TestPropertyCheckedFunction)
