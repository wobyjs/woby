...
TestContextDynamicContext.test = {
    ...
    expect: () => {
        ...
        const expectedFull = '<h3>Dynamic - Context</h3><context-provider value="context" symbol="Symbol()"><p>context</p><p><p>context</p><p></p><p></p><p></p></p><p><p>default</p><p></p><p></p><p></p></p><p><p>default</p><p></p><p></p><p></p></p></context-provider><h3>Context.Provider(value, () => ) Test</h3><context-provider value="dynamic-function-value" symbol="Symbol()"><p>Dynamic function provider: dynamic-function-value</p><p>Dynamic content: dynamic-function-value</p></context-provider>'  // For SSR comparison
