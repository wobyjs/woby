...
test('TestSymbolFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Symbol - Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestSymbolFunction'] = randomize
    })
