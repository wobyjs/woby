...
test('playground demo should render TestUndefinedRemoval component with correct snapshot', async ({ page }) => {
    ...
    const componentHeading = page.locator('h3', { hasText: 'Undefined - Removal' });
