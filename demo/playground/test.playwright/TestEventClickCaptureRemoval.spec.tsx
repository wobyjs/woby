...
test('TestEventClickCaptureRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Click Capture Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementTestEventClickCaptureRemoval'] = increment
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestEventClickCaptureRemoval']()
    })
