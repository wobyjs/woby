...
test('TestChildOverReexecution component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestChildOverReexecution']()
    })
