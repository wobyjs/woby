...
test('TestClassesArrayCleanup component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Array Cleanup'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesArrayCleanup'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesArrayCleanup']()
    })
