...
test('TestCheckboxIndeterminateToggle component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestCheckboxIndeterminateToggle'] = toggle
    })

    // For static test, verify initial state
    const element = page.locator('h3:has-text("Checkbox - Indeterminate Toggle")')
