...
test('TestIfNestedFunctionNarrowed component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'If - Nested Function Narrowed'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementTestIfNestedFunctionNarrowed'] = increment
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestIfNestedFunctionNarrowed']()
    })
