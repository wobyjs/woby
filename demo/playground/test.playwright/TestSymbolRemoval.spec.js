...
test('playground demo should render TestSymbolRemoval component with correct snapshot', async ({ page }) => {
    ...
    const componentHeading = page.locator('h3', { hasText: 'Symbol - Removal' });
