...
test('TestDynamicObservableProps component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Dynamic - Observable Props'),            h('p', null, "<Dynamic component="h5" props={props}>
                Content
            </Dynamic>")
        )
        ...
        ;(document.body as any)['toggleTestDynamicObservableProps'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestDynamicObservableProps']()
    })
