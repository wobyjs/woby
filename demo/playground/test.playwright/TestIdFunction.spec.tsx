...
test('TestIdFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'ID - Function'),            h('p', {'id': {(), '': true}, "o()}>content")
        )
        ...
        ;(document.body as any)['toggleTestIdFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestIdFunction']()
    })
