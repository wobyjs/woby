...
test('TestStyleFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Style - Function'),            h('p', {'style': {{, 'color:': true, '()': true, '': true}, "o() }}>content")
        )
        ...
        ;(document.body as any)['toggleTestStyleFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStyleFunction']()
    })
