...
test('TestStylesObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Styles - Observable'),            h('p', {'style': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestStylesObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStylesObservable']()
    })
