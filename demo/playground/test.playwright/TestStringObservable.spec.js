...
test('playground demo should render TestStringObservable component with correct snapshot', async ({ page }) => {
    ...
    const componentHeading = page.locator('h3', { hasText: 'String - Observable' });
