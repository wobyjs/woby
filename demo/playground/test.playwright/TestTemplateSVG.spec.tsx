...
test('TestTemplateSVG component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Template - SVG'),            h('p', null, "<Templated color={color} />")
        )
    ...
    await page.evaluate(() => {
        (document.body as any)['updateTestTemplateSVG']()
    })
