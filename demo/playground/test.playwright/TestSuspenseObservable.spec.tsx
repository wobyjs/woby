...
test('TestSuspenseObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const refetch = () => o((prev: any) => {
            ...
            ; (document.body as any)['refetchTestSuspenseObservable'] = refetch
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['refetchTestSuspenseObservable']()
    })
