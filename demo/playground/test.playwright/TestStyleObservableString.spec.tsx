...
test('TestStyleObservableString component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Style - Observable String'),            h('p', {'style': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestStyleObservableString'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStyleObservableString']()
    })
