...
test('TestNumberObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Number - Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestNumberObservable'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestNumberObservable']()
    })
