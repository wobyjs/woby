...
declare global {
    interface Window {
        testClassesArrayFunctionMultiple: import('woby').Observable<[string | boolean, string | boolean]>
    }
}
...
test('Classes - Array Function Multiple component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        window.testClassesArrayFunctionMultiple = o  // Make observable accessible globally
    ...
    await page.evaluate(() => {
        const o = window.testClassesArrayFunctionMultiple
        const toggle = () => o(prev => prev[0] ? [false, 'blue'] : ['red bold', false])
        toggle()
    })
    await page.waitForTimeout(50)
