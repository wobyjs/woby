...
declare global {
    interface Window {
        testClassesObjectObservable: import('woby').Observable<Record<string, boolean>>
    }
}
...
test('Classes - Object Observable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        window.testClassesObjectObservable = o  // Make observable accessible globally
    ...
    await page.evaluate(() => {
        const o = window.testClassesObjectObservable
        const toggle = () => o(prev => prev.red ? { red: false, blue: true } : { red: true, blue: false })
        toggle()
    })
