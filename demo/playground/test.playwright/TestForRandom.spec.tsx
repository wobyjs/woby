...
test('TestForRandom component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'For - Random Only Child'),<For values={values}>
                {(value: number) => {
        ...
        ;(document.body as any)['updateTestForRandom'] = update
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['updateTestForRandom']()
    })
