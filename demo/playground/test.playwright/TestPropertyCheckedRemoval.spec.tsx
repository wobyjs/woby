...
test('TestPropertyCheckedRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Property - Checked Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestPropertyCheckedRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestPropertyCheckedRemoval']()
    })
