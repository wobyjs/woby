...
test('TestPropertyValueObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Property - Value Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestPropertyValueObservable'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestPropertyValueObservable']()
    })
