...
test('TestStyleFunctionNumeric component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Style - Function Numeric'),            h('p', {'style': {(), '': true}, "o()}>content")
        )
        ...
        ;(document.body as any)['toggleTestStyleFunctionNumeric'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStyleFunctionNumeric']()
    })
