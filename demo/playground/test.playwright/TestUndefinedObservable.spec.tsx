...
test('TestUndefinedObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Undefined - Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestUndefinedObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestUndefinedObservable']()
    })
