...
test('playground demo should render TestBooleanStatic component with correct snapshot', async ({ page }) => {
    ...
    const componentHeading = page.locator('h3', { hasText: 'Boolean - Static' });
    ...
    if (componentCount > 0) {
        ...
        console.log('Playground demo TestBooleanStatic component renders correct snapshot');
    }
});
