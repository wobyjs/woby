...
test('TestStyleFunctionVariable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Style - Function Variable'),            h('p', {'style': {{, 'color:': true, ''var(--color)',': true, ''--color':': true, '()': true, '': true}, "o() }}>content")
        )
        ...
        ;(document.body as any)['toggleTestStyleFunctionVariable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStyleFunctionVariable']()
    })
