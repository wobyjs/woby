...
test('TestIfNestedFunctionUnnarrowed component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'If - Nested Function Unnarrowed'),            h('p', {}, "[observable-content]")
        )
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestIfNestedFunctionUnnarrowed']()
    })
