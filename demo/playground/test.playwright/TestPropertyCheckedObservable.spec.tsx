...
test('TestPropertyCheckedObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Property - Checked Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestPropertyCheckedObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestPropertyCheckedObservable']()
    })
