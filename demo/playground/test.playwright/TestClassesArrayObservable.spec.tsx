...
test('TestClassesArrayObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Array Observable'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesArrayObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesArrayObservable']()
    })
