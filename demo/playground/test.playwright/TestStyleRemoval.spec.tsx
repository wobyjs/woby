...
test('TestStyleRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Style - Removal'),            h('p', {'style': {{, 'color:': true, 'o': true, '}}': true}, "content")
        )
        ...
        ;(document.body as any)['toggleTestStyleRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStyleRemoval']()
    })
