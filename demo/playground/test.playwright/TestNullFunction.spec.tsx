...
test('TestNullFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Null - Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestNullFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestNullFunction']()
    })
