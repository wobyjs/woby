...
test('TestDynamicObservableComponent component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Dynamic - Observable Component'),            h('p', null, "<Dynamic component={component}>
                Level: {level}
            </Dynamic>")
        )
        ...
        ;(document.body as any)['incrementTestDynamicObservableComponent'] = increment
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestDynamicObservableComponent']()
    })
