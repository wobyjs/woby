...
test('TestStylesFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Styles - Function'),            h('p', {'style': {(), '': true}, "o()}>content")
        )
        ...
        ;(document.body as any)['toggleTestStylesFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStylesFunction']()
    })
