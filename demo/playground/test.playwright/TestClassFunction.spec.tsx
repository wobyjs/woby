...
test('TestClassFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Class - Function Boolean'),            h('p', {'class': {{, 'red:': true, '()': true, '': true}, "o() }}>content")
        )
        ...
        ;(document.body as any)['toggleTestClassFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassFunction']()
    })
