...
test('TestClassFunctionString component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Class - Function String'),            h('p', {'class': {(), '': true}, "o()}>content")
        )
        ...
        ;(document.body as any)['toggleTestClassFunctionString'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassFunctionString']()
    })
