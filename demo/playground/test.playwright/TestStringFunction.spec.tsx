...
test('TestStringFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'String - Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestStringFunction'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestStringFunction']()
    })
