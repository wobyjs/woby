...
test('TestForFallbackObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'For - Fallback Observable'),<For values={[]} fallback={<Fallback />}>
                {(value: number) => {
        ...
        ;(document.body as any)['randomizeTestForFallbackObservable'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestForFallbackObservable']()
    })
