...
test('TestTernaryObservableChildren component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestTernaryObservableChildren']()
    })
