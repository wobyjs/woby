...
test('TestAttributeFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            ...
            h('p', { 'data-color': o }, "[observable-content]")
        )
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestAttributeFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestAttributeFunction']()
    })
