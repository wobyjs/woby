...
test('TestHTMLDangerouslySetInnerHTMLObservableString component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'HTML - dangerouslySetInnerHTML - Observable String'),            h('p', {'dangerouslySetInnerHTML': {{, '__html:': true, 'o': true, '}}': true})
        )
        ...
        ;(document.body as any)['toggleTestHTMLDangerouslySetInnerHTMLObservableString'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestHTMLDangerouslySetInnerHTMLObservableString']()
    })
