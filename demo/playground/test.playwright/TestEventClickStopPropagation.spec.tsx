...
test('TestEventClickStopPropagation component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Click - Stop Propagation'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementOuterTestEventClickStopPropagation'] = incrementOuter
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementOuterTestEventClickStopPropagation']()
    })
