...
test('TestABCD component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Children - ABCD'),            h('p', {}, "[observable-content]")
        )
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestABCD']()
    })
