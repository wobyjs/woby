...
test('TestClassObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Class - Observable'),            h('p', {'class': {{, 'red:': true, 'o': true, '}}': true}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassObservable']()
    })
