...
test('playground demo should render TestSymbolFunction component with correct snapshot', async ({ page }) => {
    ...
    const componentHeading = page.locator('h3', { hasText: 'Symbol - Function' });
