...
test('TestHTMLDangerouslySetInnerHTMLFunctionString component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'HTML - dangerouslySetInnerHTML - Function String'),            h('p', null, "<p dangerouslySetInnerHTML={{ __html: () => o() }} />")
        )
        ...
        ;(document.body as any)['toggleTestHTMLDangerouslySetInnerHTMLFunctionString'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestHTMLDangerouslySetInnerHTMLFunctionString']()
    })
