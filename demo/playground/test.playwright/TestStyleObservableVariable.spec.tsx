...
test('TestStyleObservableVariable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Style - Observable Variable'),            h('p', {'style': {{, 'color:': true, ''var(--color)',': true, ''--color':': true, 'o': true, '}}': true}, "content")
        )
        ...
        ;(document.body as any)['toggleTestStyleObservableVariable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStyleObservableVariable']()
    })
