...
test('TestBooleanRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Boolean - Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestBooleanRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestBooleanRemoval']()
    })
