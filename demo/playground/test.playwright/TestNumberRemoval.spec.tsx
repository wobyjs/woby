...
test('TestNumberRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Number - Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestNumberRemoval'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestNumberRemoval']()
    })
