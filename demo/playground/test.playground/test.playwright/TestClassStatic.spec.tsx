...
declare global {
    interface Window {
        testTestClassStatic: import('woby').Observable<undefined>
    }
}
...
test('Class - Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Create component logic based on TestClassStatic.tsx
        // Static component with class
    ...
    const expectedHTML = '<div><h3>Class - Static</h3><p class="red">content</p></div>'
