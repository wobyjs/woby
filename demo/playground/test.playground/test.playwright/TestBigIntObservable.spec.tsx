...
test('Big Int Observable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const o = woby.$(456n)  // Initial BigInt value from source
    ...
    await expect(outerHTML).toBe('<p>456n</p>')  // Expected output - BigInt renders with 'n' suffix
})
