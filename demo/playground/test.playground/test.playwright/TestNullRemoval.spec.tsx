...
declare global {
    interface Window {
        testObservableNullRemoval: import('woby').Observable<any>;
    }
}

test('Null Removal component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestNullRemoval.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Null Removal'),
