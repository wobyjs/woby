...
declare global {
    interface Window {
        testObservableClassObservable: import('woby').Observable<any>
    }
}
...
test('Class Observable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestClassObservable.tsx]
        ...
        const element = h('div', null,
            ...
            h('p', { class: { red: o } } as any, 'content')  // Use object for class attribute with observable
        )
    ...
    expect(innerHTML).toContain('<h3>Class - Observable</h3>')
