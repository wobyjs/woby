...
declare global {
    interface Window {
        testObservableEventEnterAndEnterCaptureStatic: import('woby').Observable<any>;
    }
}

test('Event Enter And Enter Capture Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestEventEnterAndEnterCaptureStatic.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Event Enter And Enter Capture Static'),
