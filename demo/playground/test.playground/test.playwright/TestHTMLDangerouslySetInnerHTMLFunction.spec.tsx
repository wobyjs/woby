...
declare global {
    interface Window {
        testTestHTMLDangerouslySetInnerHTMLFunction: import('woby').Observable<undefined>
    }
}

test('HTML - dangerouslySetInnerHTML - Function component', async ({ page }) => {
    ...
    // TODO: Add proper expectations based on TestHTMLDangerouslySetInnerHTMLFunction.tsx
