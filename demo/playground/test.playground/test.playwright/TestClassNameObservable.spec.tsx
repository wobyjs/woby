...
declare global {
    interface Window {
        testObservableClassNameObservable: import('woby').Observable<any>
    }
}

test('Class Name Observable component', async ({ page }) => {
    ...
    await expect(innerHTML).toBe('<h3>ClassName - Observable</h3><p class="red">content</p>')
})
