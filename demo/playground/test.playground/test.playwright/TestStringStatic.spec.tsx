...
declare global {
    interface Window {
        testTestStringStatic: import('woby').Observable<undefined>
    }
}

test('String - Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestStringStatic.tsx]

        // Create the component element using h() function - static content
        const element = h('div', null,
            h('h3', null, 'String - Static'),
            h('p', null, 'string')
        )
    ...
    await expect(innerHTML).toBe('<h3>String - Static</h3><p>string</p>')  // Expected output from source
})
