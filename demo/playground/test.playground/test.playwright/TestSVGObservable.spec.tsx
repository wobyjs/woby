...
declare global {
    interface Window {
        testTestSVGObservable: import('woby').Observable<any>
    }
}

test('SVG - Observable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'SVG - Observable'),
            h('svg', { viewBox: '0 0 50 50', width: '50px', stroke: '#abcdef', strokeWidth: '3', fill: 'white' },
