...
declare global {
    interface Window {
        testTestClassesObjectStaticMultiple: import("woby").Observable<Record<string, boolean>>
    }
}

test('Classes - Object Static Multiple component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Create component logic based on TestClassesObjectStaticMultiple.tsx
        // Static component with object classes

        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Classes - Object Static Multiple'),
            h('p', { class: { 'red bold': true } }, 'content')
        )
    ...
    const expectedHTML = '<div><h3>Classes - Object Static Multiple</h3><p class="red bold">content</p></div>'
