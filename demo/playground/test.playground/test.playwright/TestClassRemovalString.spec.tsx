...
declare global {
    interface Window {
        testTestClassRemovalString: import('woby').Observable<string | null>
    }
}
...
test('Class - Removal String component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Create component logic based on TestClassRemovalString.tsx
        // Dynamic component with string class removal

        const o = $('red')
        window.testTestClassRemovalString = o
    ...
    await page.evaluate(() => {
        const o = window.testTestClassRemovalString
        const toggle = () => o(prev => prev ? null : 'red')
        toggle()
    })
    await page.waitForTimeout(50)
    ...
    // Step 2: toggle class -> 'red' (since o becomes 'red' again)
    await page.evaluate(() => {
        const o = window.testTestClassRemovalString
        const toggle = () => o(prev => prev ? null : 'red')
        toggle()
