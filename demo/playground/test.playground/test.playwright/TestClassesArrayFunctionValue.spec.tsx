...
declare global {
    interface Window {
        testObservableClassesArrayFunctionValue: import('woby').Observable<any>
    }
}
...
test('Classes Array Function Value component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Observable for class value
        const o = $('red')

        // Create the component element using h() function with array containing function
    ...
    await expect(innerHTML).toBe('<h3>Classes - Array Function Value</h3><p class="red">content</p>')
})
