...
declare global {
    interface Window {
        testObservableClassObservableString: import('woby').Observable<any>
    }
}
...
test('Class Observable String component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestClassObservableString.tsx]
        ...
        const element = h('div', null,
            ...
            h('p', { class: o } as any, 'content')  // Use observable directly for class attribute
        )
    ...
    expect(innerHTML).toContain('<h3>Class - Observable String</h3>')
