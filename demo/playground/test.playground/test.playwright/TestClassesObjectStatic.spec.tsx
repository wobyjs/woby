...
declare global {
    interface Window {
        testTestClassesObjectStatic: import("woby").Observable<Record<string, boolean>>
    }
}

test('Classes - Object Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Create component logic based on TestClassesObjectStatic.tsx
        // Static component with object classes

        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Classes - Object Static'),
    ...
    const expectedHTML = '<div><h3>Classes - Object Static</h3><p class="red">content</p></div>'
