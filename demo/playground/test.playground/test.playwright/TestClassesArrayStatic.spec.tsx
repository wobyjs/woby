...
declare global {
    interface Window {
        testTestClassesArrayStatic: import("woby").Observable<string>
    }
}
...
test('Classes - Array Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Create component logic based on TestClassesArrayStatic.tsx
        // Static component with array classes

        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Classes - Array Static'),
            h('p', { class: ['red', false && 'blue', null && 'blue', undefined && 'blue'] }, 'content')
        )
    ...
    const expectedHTML = '<div><h3>Classes - Array Static</h3><p class="red">content</p></div>'
