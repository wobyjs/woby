...
declare global {
    interface Window {
        testObservableStringRemoval: import('woby').Observable<any>;
    }
}

test('String Removal component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestStringRemoval.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'String Removal'),
