...
declare global {
    interface Window {
        testObservableClassesArrayRemovalMultiple: import('woby').Observable<any>
    }
}
...
test('Classes Array Removal Multiple component', async ({ page }) => {
    ...
    await expect(innerHTML).toBe('<h3>Classes - Array Removal Multiple</h3><p class="red bold">content</p>')
})
