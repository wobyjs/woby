...
declare global {
    interface Window {
        testTestBigIntStatic: import('woby').Observable<undefined>
    }
}

test('BigInt - Static component', async ({ page }) => {
    ...
    await expect(innerHTML).toBe('<h3>BigInt - Static</h3><p>123123n</p>')  // Expected output from source
})
