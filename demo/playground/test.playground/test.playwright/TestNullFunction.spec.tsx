...
declare global {
    interface Window {
        testObservableNullFunction: import('woby').Observable<any>;
    }
}

test('Null Function component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestNullFunction.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Null Function'),
