...
declare global {
    interface Window {
        testTestSwitchCaseObservableStatic: import('woby').Observable<any>
    }
}

test('Switch - Case Observable Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            ...
            h(Switch, { when: 0 } as any,
                h(Switch.Case, { when: 0 } as any, h(Case)),
