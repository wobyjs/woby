...
test('If Observable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestIfObservable.tsx]
    ...
    await expect(innerHTML).toBe('<h3>If - Observable</h3><p>(content)</p>')  // Expected output from source
})