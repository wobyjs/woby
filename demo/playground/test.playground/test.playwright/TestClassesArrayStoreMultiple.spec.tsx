...
declare global {
    interface Window {
        testObservableClassesArrayStoreMultiple: import('woby').Observable<any>
    }
}
...
test('Classes Array Store Multiple component', async ({ page }) => {
    ...
    await expect(innerHTML).toBe('<h3>Classes - Array Store Multiple</h3><p class="red bold">content</p>')
})
