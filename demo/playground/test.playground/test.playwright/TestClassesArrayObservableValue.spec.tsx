...
declare global {
    interface Window {
        testObservableClassesArrayObservableValue: import('woby').Observable<any>
    }
}
...
test('Classes Array Observable Value component', async ({ page }) => {
    ...
    await expect(innerHTML).toBe('<h3>Classes - Array Observable Value</h3><p class="red">red</p>')
})
