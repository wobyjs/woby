...
declare global {
    interface Window {
        testTestClassStaticString: import('woby').Observable<undefined>
    }
}
...
test('Class - Static String component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Create component logic based on TestClassStaticString.tsx
        // Static component with string class
    ...
    const expectedHTML = '<div><h3>Class - Static String</h3><p class="red">content</p></div>'
