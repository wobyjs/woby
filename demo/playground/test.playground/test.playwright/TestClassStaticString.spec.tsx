...
test('Class Static String component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestClassStaticString.tsx]

        // Create the component element using h() function - static content
        const element = h('div', null,
            h('h3', null, 'Class - Static String'),
            h('p', { class: 'red' } as any, 'content')  // Use static string for class attribute
        )
    ...
    await expect(innerHTML).toBe('<h3>Class - Static String</h3><p class="red">content</p>')  // Expected output from source
})