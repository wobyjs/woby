...
declare global {
    interface Window {
        testObservableUndefinedFunction: import('woby').Observable<any>;
    }
}

test('Undefined Function component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestUndefinedFunction.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Undefined Function'),
