...
test('Event Click And Click Capture Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestEventClickAndClickCaptureStatic.tsx]
        
        // Create the component element using h() function - static content
        const element = h('div', null,
            h('h3', null, 'Event Click And Click Capture Static'),
