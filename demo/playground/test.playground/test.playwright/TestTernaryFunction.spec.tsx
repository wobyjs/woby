...
declare global {
    interface Window {
        testObservableTernaryFunction: import('woby').Observable<any>
    }
}
...
test('Ternary Function component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestTernaryFunction.tsx]
    ...
    // Check that the component contains a paragraph (either 'true' or 'false' depending on the negated value)
