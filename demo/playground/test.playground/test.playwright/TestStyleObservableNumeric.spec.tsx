...
declare global {
    interface Window {
        testObservableStyleObservableNumeric: import('woby').Observable<any>;
    }
}

test('Style Observable Numeric component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestStyleObservableNumeric.tsx]
