...
declare global {
    interface Window {
        testObservableClassesArrayObservableMultiple: import('woby').Observable<any>
    }
}
...
test('Classes Array Observable Multiple component', async ({ page }) => {
    ...
    await expect(innerHTML).toBe('<h3>Classes - Array Observable Multiple</h3><p class="red bold">content</p>')
})
