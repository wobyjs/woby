...
test('Null Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Source has <p>{null}</p> which renders as <p></p>

        // Create the component element using h() function - static content
        const element = h('div', null,
            h('h3', null, 'Null - Static'),
            h('p', null, null)  // Source has {null} which renders as empty content
        )
    ...
    await expect(outerHTML).toBe('<p><!----></p>')  // Expected output - null renders as placeholder
})
