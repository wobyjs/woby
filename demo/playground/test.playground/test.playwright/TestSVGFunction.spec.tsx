...
declare global {
    interface Window {
        testObservableSVGFunction: import('woby').Observable<any>;
    }
}

test('S V G Function component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestSVGFunction.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'S V G Function'),
