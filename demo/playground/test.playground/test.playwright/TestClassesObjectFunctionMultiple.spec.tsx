...
declare global {
    interface Window {
        testClassesObjectFunctionMultiple: import('woby').Observable<{ 'red bold': boolean; blue: boolean }>
    }
}
...
test('Classes - Object Function Multiple component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        window.testClassesObjectFunctionMultiple = o  // Make observable accessible globally
    ...
    await page.evaluate(() => {
        const o = window.testClassesObjectFunctionMultiple
        const toggle = () => o(prev => prev['red bold'] ? { 'red bold': false, blue: true } : { 'red bold': true, blue: false })
        toggle()
    })
