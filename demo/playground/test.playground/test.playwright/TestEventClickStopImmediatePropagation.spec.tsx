...
declare global {
    interface Window {
        testObservableEventClickStopImmediatePropagation: import('woby').Observable<any>;
    }
}

test('Event Click Stop Immediate Propagation component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestEventClickStopImmediatePropagation.tsx]
