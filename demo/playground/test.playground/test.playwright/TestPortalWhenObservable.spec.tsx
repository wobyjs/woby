...
declare global {
    interface Window {
        testTestPortalWhenObservable: import('woby').Observable<undefined>
    }
}

test('Portal - When Observable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Portal - When Observable'),
            h(Portal, { mount: document.body, when: true } as any, '')
        )
