...
declare global {
    interface Window {
        testTestHTMLDangerouslySetInnerHTMLStatic: import('woby').Observable<undefined>
    }
}

test('HTML - dangerouslySetInnerHTML - Static component', async ({ page }) => {
    ...
    // TODO: Add proper expectations based on TestHTMLDangerouslySetInnerHTMLStatic.tsx
