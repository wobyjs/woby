...
declare global {
    interface Window {
        testTestStyleStatic: import('woby').Observable<undefined>
    }
}
...
test('Style - Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestStyleStatic.tsx]
    ...
    await expect(innerHTML).toBe('<h3>Style - Static</h3><p style="color: green;">content</p>')  // Expected output from source
})
