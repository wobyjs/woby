...
test('Attribute Function Boolean component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // Source has data-red={() => !o()} where o is true, so !o() = false
        // Expected output: <p data-red="false">content</p>
        ...
        const element = h('div', null,
            ...
            h('p', { 'data-red': () => !o() } as any, 'content')  // Function attribute from source
        )
    ...
    await expect(outerHTML).toBe('<p data-red="false">content</p>')  // Expected output - !true = false
})
