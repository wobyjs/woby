...
declare global {
    interface Window {
        testObservableNullObservable: import('woby').Observable<any>;
    }
}

test('Null Observable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestNullObservable.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Null Observable'),
