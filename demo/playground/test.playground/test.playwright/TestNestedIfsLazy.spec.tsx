...
declare global {
    interface Window {
        testObservableNestedIfsLazy: import('woby').Observable<any>;
    }
}

test('Nested Ifs Lazy component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestNestedIfsLazy.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Nested Ifs Lazy'),
