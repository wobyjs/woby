...
declare global {
    interface Window {
        testTestPromiseResolved: import('woby').Observable<undefined>
    }
}

test('Promise - Resolved component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestPromiseResolved.tsx]
    ...
    await expect(innerHTML).toBe('<h3>Promise - Resolved</h3><p>Loaded!</p>')  // Expected output from source
})
