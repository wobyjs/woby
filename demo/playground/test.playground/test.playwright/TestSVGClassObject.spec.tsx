...
declare global {
    interface Window {
        testTestSVGClassObject: import('woby').Observable<any>
    }
}

test('SVG - Class Object component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            ...
            h('svg', { className: { red: true }, viewBox: '0 0 50 50', width: '50px', strokeWidth: '3', fill: 'white' },
