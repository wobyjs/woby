...
declare global {
    interface Window {
        testTestSwitchFallbackFunction: import('woby').Observable<any>
    }
}

test('Switch - Fallback Function component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Switch - Fallback Function'),
            h(Switch, { when: -1, fallback: Fallback } as any,
