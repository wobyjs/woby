...
declare global {
    interface Window {
        testTestSVGStatic: import('woby').Observable<any>
    }
}

test('SVG - Static component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'SVG - Static'),
            h('svg', { viewBox: '0 0 50 50', width: '50px', xmlns: 'http://www.w3.org/2000/svg', stroke: '#ef8eb9', strokeWidth: '3', fill: 'white' },
    ...
    await expect(svgElement).toHaveAttribute('stroke', '#ef8eb9')
