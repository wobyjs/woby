...
declare global {
    interface Window {
        testObservableTemplateSVG: import('woby').Observable<any>;
    }
}

test('Template S V G component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestTemplateSVG.tsx]
        
        // Create the component element using h() function
        const element = h('div', null,
            h('h3', null, 'Template S V G'),
