...
declare global {
    interface Window {
        testObservableEventEnterStopImmediatePropagation: import('woby').Observable<any>;
    }
}
...
test('Event Enter Stop Immediate Propagation component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestEventEnterStopImmediatePropagation.tsx]
