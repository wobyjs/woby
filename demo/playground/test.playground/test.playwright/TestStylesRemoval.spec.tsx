...
declare global {
    interface Window {
        testObservableStylesRemoval: import('woby').Observable<any>;
    }
}

test('Styles Removal component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestStylesRemoval.tsx]
