...
declare global {
    interface Window {
        testObservableBooleanRemoval: import('woby').Observable<any>
    }
}
...
test('Boolean Removal component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        // [Implementation based on source file: TestBooleanRemoval.tsx]
    ...
    // Check that the component contains the expected structure with boolean rendering
    expect(innerHTML).toContain('<h3>Boolean - Removal</h3>')
