...
test('TestClassNameObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'ClassName - Observable'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassNameObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassNameObservable']()
    })
