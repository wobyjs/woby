...
test('TestTabIndexBooleanFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'TabIndex - Boolean - Function'),
            h('p', { 'tabIndex': () => o() }, "content")
        )
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestTabIndexBooleanFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestTabIndexBooleanFunction']()
    })
