...
test('TestIdObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'ID - Observable'),            h('p', {'id': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestIdObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestIdObservable']()
    })
