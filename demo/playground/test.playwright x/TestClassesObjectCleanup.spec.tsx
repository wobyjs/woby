...
test('TestClassesObjectCleanup component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Object Cleanup'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesObjectCleanup'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesObjectCleanup']()
    })
