...
test('TestUndefinedFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Undefined - Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestUndefinedFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestUndefinedFunction']()
    })
