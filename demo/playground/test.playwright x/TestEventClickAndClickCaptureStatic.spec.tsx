...
test('TestEventClickAndClickCaptureStatic component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Click & Click Capture Static'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementTestEventClickAndClickCaptureStatic'] = increment
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestEventClickAndClickCaptureStatic']()
    })
