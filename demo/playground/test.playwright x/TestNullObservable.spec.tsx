...
test('TestNullObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Null - Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestNullObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestNullObservable']()
    })
