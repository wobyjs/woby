...
test('TestEventClickObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Click Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['plus2TestEventClickObservable'] = plus2
        ;(document.body as any)['minus1TestEventClickObservable'] = minus1
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['plus2TestEventClickObservable']()
    })
