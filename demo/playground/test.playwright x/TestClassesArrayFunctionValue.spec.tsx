...
test('TestClassesArrayFunctionValue component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestClassesArrayFunctionValue'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesArrayFunctionValue']()
    })
