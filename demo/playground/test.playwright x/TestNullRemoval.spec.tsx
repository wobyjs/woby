...
test('TestNullRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Null - Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestNullRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestNullRemoval']()
    })
