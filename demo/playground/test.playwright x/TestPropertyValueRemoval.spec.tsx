...
test('TestPropertyValueRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Property - Value Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestPropertyValueRemoval'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestPropertyValueRemoval']()
    })
