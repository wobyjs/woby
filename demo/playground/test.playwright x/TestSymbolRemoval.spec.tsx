...
test('TestSymbolRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Symbol - Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestSymbolRemoval'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestSymbolRemoval']()
    })
