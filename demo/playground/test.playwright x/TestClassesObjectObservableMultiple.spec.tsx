...
test('TestClassesObjectObservableMultiple component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Object Observable Multiple'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesObjectObservableMultiple'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesObjectObservableMultiple']()
    })
