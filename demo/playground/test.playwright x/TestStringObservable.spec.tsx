...
test('TestStringObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'String - Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestStringObservable'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestStringObservable']()
    })
