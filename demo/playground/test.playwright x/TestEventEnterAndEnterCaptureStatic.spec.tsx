...
test('TestEventEnterAndEnterCaptureStatic component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Enter & Enter Capture Static'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementTestEventEnterAndEnterCaptureStatic'] = increment
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestEventEnterAndEnterCaptureStatic']()
    })
