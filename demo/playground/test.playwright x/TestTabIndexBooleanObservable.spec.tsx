...
test('TestTabIndexBooleanObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'TabIndex - Boolean - Observable'),            h('p', {'tabIndex': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestTabIndexBooleanObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestTabIndexBooleanObservable']()
    })
