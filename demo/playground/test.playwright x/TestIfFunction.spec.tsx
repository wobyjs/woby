...
test('TestIfFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'If - Function'), h('p', {}, "[observable-content]")
        )
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestIfFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestIfFunction']()
    })
