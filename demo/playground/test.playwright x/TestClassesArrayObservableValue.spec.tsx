...
test('TestClassesArrayObservableValue component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Array Observable Value'),            h('p', {'class': {o}}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestClassesArrayObservableValue'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesArrayObservableValue']()
    })
