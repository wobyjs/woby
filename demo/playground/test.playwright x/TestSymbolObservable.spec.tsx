...
test('TestSymbolObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Symbol - Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestSymbolObservable'] = randomize
    })
