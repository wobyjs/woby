...
test('TestForUnkeyedFallbackObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'For - Unkeyed - Fallback Observable'),<For values={[]} fallback={<Fallback />} unkeyed>
        ...
        ;(document.body as any)['randomizeTestForUnkeyedFallbackObservable'] = randomize
    })
    ...
    // Manually trigger the randomize function 4 times (replacing useInterval)
    await page.evaluate(() => {
        (document.body as any)['randomizeTestForUnkeyedFallbackObservable']()
    })
