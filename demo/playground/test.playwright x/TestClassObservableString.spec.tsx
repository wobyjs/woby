...
test('TestClassObservableString component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Class - Observable String'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassObservableString'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassObservableString']()
    })
