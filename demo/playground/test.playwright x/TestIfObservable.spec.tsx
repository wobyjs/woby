...
test('TestIfObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'If - Observable'), h('p', {}, "[observable-content]")
        )
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestIfObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestIfObservable']()
    })
