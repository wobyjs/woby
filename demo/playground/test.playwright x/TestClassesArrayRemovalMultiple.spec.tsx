...
test('TestClassesArrayRemovalMultiple component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Array Removal Multiple'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesArrayRemovalMultiple'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesArrayRemovalMultiple']()
    })
