...
test('TestClassesObjectRemovalMultiple component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Object Removal Multiple'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesObjectRemovalMultiple'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesObjectRemovalMultiple']()
    })
