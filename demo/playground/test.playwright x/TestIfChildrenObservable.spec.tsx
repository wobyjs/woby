...
test('TestIfChildrenObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'If - Children Observable'),            h('p', null, "<If when={true}>{o}</If>")
        )
        ...
        ;(document.body as any)['randomizeTestIfChildrenObservable'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestIfChildrenObservable']()
    })
