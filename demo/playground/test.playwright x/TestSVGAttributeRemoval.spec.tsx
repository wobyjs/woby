...
test('TestSVGAttributeRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            ...
            h('svg', { 'class': 'red', 'viewBox': '0 0 50 50', 'width': '50px', 'stroke-width': '3', 'fill': 'white' }, "[observable-content]")
        )
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestSVGAttributeRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestSVGAttributeRemoval']()
    })
