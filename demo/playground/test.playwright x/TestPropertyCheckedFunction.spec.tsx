...
test('TestPropertyCheckedFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Property - Checked Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestPropertyCheckedFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestPropertyCheckedFunction']()
    })
