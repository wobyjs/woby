...
test('TestComponentObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Component - Observable'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestComponentObservable'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestComponentObservable']()
    })
