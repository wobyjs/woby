...
test('TestClassesObjectObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Object Observable'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesObjectObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesObjectObservable']()
    })
