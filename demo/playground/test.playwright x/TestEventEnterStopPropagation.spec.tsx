...
test('TestEventEnterStopPropagation component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Enter - Stop Propagation'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementOuterTestEventEnterStopPropagation'] = incrementOuter
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementOuterTestEventEnterStopPropagation']()
    })
