...
test('TestClassRemovalString component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Class - Removal String'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassRemovalString'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassRemovalString']()
    })
