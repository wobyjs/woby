...
test('TestStylesCleanup component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Styles - Observable Cleanup'),            h('p', {'style': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestStylesCleanup'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStylesCleanup']()
    })
