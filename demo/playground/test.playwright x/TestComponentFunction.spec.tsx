...
test('TestComponentFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Component - Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestComponentFunction'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestComponentFunction']()
    })
