...
test('TestStringRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'String - Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestStringRemoval'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestStringRemoval']()
    })
