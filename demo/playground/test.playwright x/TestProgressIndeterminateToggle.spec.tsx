...
test('TestProgressIndeterminateToggle component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Progress - Indeterminate Toggle'),            h('progress', {'value': {o}})
        )
        ...
        ;(document.body as any)['cycleTestProgressIndeterminateToggle'] = cycle
    })
    ...
    // Manually trigger the cycle function 4 times (replacing useInterval)
    await page.evaluate(() => {
        (document.body as any)['cycleTestProgressIndeterminateToggle']()
    })
