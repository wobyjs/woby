...
test('TestEventEnterStopImmediatePropagation component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Enter - Stop Immediate Propagation'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementOuterTestEventEnterStopImmediatePropagation'] = incrementOuter
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementOuterTestEventEnterStopImmediatePropagation']()
    })
