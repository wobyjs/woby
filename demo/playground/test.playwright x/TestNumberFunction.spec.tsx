...
test('TestNumberFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Number - Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestNumberFunction'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestNumberFunction']()
    })
