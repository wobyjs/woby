...
test('TestPropertyValueFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Property - Value Function'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestPropertyValueFunction'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestPropertyValueFunction']()
    })
