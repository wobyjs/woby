...
test('TestIfFallbackObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'If - Fallback Observable'),            h('p', null, "<If when={false} fallback={<Fallback />}>Children</If>")
        )
        ...
        ;(document.body as any)['randomizeTestIfFallbackObservable'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestIfFallbackObservable']()
    })
