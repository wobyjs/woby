...
test('TestTernaryChildrenFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const randomize = () => o((prev: any) => {
            ...
            ; (document.body as any)['randomizeTestTernaryChildrenFunction'] = randomize
    })

    // For static test, verify initial state
    const element = page.locator('h3:has-text("Ternary - Children Function")')
