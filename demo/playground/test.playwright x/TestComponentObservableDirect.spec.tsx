...
test('TestComponentObservableDirect component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Component - Observable Direct'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['randomizeTestComponentObservableDirect'] = randomize
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['randomizeTestComponentObservableDirect']()
    })
