...
test('TestClassesArrayObservableMultiple component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Array Observable Multiple'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesArrayObservableMultiple'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesArrayObservableMultiple']()
    })
