...
test('TestPortalWhenObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Portal - When Observable'),<Portal mount={document.body} when={when}>
                            h('p', {}, "content")
            </Portal>
        )
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestPortalWhenObservable']()
    })
