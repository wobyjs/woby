...
test('TestEventMiddleClickCaptureStatic component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Middle Click Capture Static'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementTestEventMiddleClickCaptureStatic'] = increment
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestEventMiddleClickCaptureStatic']()
    })
