...
test('TestSwitchFallbackObservableStatic component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            ...
            h('Switch', { when: -1, fallback: h('Fallback', {}) },
        ...
        const randomize = () => o((prev: any) => {
            ...
            ; (document.body as any)['randomizeTestSwitchFallbackObservableStatic'] = randomize
    })

    // For static test, verify initial state
    const element = page.locator('h3:has-text("Switch - Fallback Observable Static")')
