...
test('TestEventClickRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Event - Click Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['incrementTestEventClickRemoval'] = increment
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['incrementTestEventClickRemoval']()
    })
