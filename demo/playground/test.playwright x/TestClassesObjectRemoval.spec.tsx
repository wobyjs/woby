...
test('TestClassesObjectRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Classes - Object Removal'),            h('p', {'class': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestClassesObjectRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestClassesObjectRemoval']()
    })
