...
test('TestTernaryObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestTernaryObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestTernaryObservable']()
    })
