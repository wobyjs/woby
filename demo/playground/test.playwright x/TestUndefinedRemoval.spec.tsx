...
test('TestUndefinedRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Undefined - Removal'),            h('p', {}, "[observable-content]")
        )
        ...
        ;(document.body as any)['toggleTestUndefinedRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestUndefinedRemoval']()
    })
