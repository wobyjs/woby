...
test('TestStylesRemoval component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'Styles - Removal'),            h('p', {'style': {o}}, "content")
        )
        ...
        ;(document.body as any)['toggleTestStylesRemoval'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestStylesRemoval']()
    })
