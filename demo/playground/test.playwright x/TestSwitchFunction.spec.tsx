...
test('TestSwitchFunction component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const toggle = () => o((prev: any) => {
            ...
            ; (document.body as any)['toggleTestSwitchFunction'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestSwitchFunction']()
    })
