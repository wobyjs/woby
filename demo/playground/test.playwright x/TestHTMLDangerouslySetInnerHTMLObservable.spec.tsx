...
test('TestHTMLDangerouslySetInnerHTMLObservable component', async ({ page }) => {
    ...
    await page.evaluate(() => {
        ...
        const element = h('div', null,
            h('h3', null, 'HTML - dangerouslySetInnerHTML - Observable'),            h('p', {'dangerouslySetInnerHTML': {o}})
        )
        ...
        ;(document.body as any)['toggleTestHTMLDangerouslySetInnerHTMLObservable'] = toggle
    })
    ...
    await page.evaluate(() => {
        (document.body as any)['toggleTestHTMLDangerouslySetInnerHTMLObservable']()
    })
