...
test('TestSuspenseMiddleman component', async ({ page }) => {
    ...
    // Manually trigger the refetch function 4 times (replacing useInterval)
    await page.evaluate(() => {
        (document.body as any)['refetchTestSuspenseMiddleman']()
    })
