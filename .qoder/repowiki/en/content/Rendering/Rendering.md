...
1. **SSR (`render.ts`)**: Focuses on generating static HTML strings without reactivity. Uses virtual containers and returns string output.
...
**Diagram sources**
- [setters.ts](file://src/utils/setters.ts#L192-L384)
- [setters.ts](file://src/utils/setters.ts#L163-L354)
