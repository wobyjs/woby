...
declare global {
    export namespace JSX {
        ...
        type ObservableMaybe<T = unknown> = ({
            (): T;
        }) | T;
        ...
        type TargetedEvent<T extends EventTarget = EventTarget, TypedEvent extends Event = Event> = Omit<TypedEvent, 'currentTarget'> & {
        ...
        type TargetedChangeEvent<T extends EventTarget> = TargetedEvent<T, Event & {
            target: T;
        }>;
        ...
        type EventHandler<Event extends TargetedEvent> = {
