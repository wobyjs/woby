import type { Child, Classes, EventListener, FunctionMaybe, ObservableMaybe, Ref, TemplateActionProxy } from '../types';
...
declare const setChildStatic: (parent: HTMLElement, child: Child, dynamic?: boolean) => void;
declare const setChild: (parent: HTMLElement, child: Child) => void;
...
declare const setTemplateAccessor: (element: HTMLElement, key: string, value: TemplateActionProxy) => Promise<void>;
declare const setProp: <T>(element: HTMLElement, key: string, value: T) => void;
