    ...
    if (isString(object)) {
        ...
        if (objectPrev) {
            ...
            if (isString(objectPrev)) {
                ...
                for (const key in objectPrev as Record<string, FunctionMaybe<boolean>>) {
        ...
        if (isArray(object)) {
            ...
            if (isStore(object)) {
                ...
                for (let i = 0, l = object.length; i < l; i++) {
                    ...
                    const fn = untrack(() => isFunction(object[i]) ? object[i] : (object[SYMBOL_STORE_OBSERVABLE] as any)(String(i))) as (() => string | boolean | null | undefined); //TSC
    ...
    if (isString(object)) {
        ...
        if (objectPrev) {
            ...
            if (isString(objectPrev)) {
                ...
                for (const key in objectPrev as Record<string, FunctionMaybe<string | number>>) {
