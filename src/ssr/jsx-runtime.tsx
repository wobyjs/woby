...
export function jsx<P extends {} = {}>(component: Component<P>, props?: P | null, ...children: Child[]): Element {
  ...
  if (children.length > 0) {
    ...
    return wrapCloneElement(createElement<P>(component as any, restProps as any, ...children) as any as Element, component, restProps as any)
  }
  ...
  if (props && 'children' in props) {
    ...
    const { children: propsChildren, ...restProps } = props as any
    return wrapCloneElement(createElement<P>(component as any, restProps as any, propsChildren) as any as Element, component, props)
  }
  ...
  return wrapCloneElement(createElement<P>(component as any, props) as any as Element, component, props)
};
